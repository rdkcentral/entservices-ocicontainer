...
############################
# Build entservices-ocicontainer
echo "buliding entservices-ocicontainer"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-ocicontainer \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-ocicontainer --target install
echo "======================================================================================"
exit 0
